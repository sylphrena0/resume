...
% experience section
\section*{Experience}
\textbf{Software Engineer II,} {Linevision, Inc} --- \textit{Hybrid} \hfill Jan 2026--Present \\
\vspace{-9pt}
\begin{itemize}[leftmargin=0.35in]
  \item Released and maintained high availability on-prem dynamic line rating solution for a major energy customer
  \item Led efforts to update legacy codebases to meet code quality and coverage standards, equipping our squads with reliable CI/CD tooling via GitHub Actions. Handled critical uptime events and managed deploys to our AWS stack.
  \item Architected critical high-availability NATS services for K8s in EKS, establishing organizational tooling and standards
\end{itemize}
\vspace{-9pt}
\textbf{SKILLS:} Python, Docker, Kubernetes, Helm, NATS, AWS EKS, CI/CD, REST APIs, GeoJSON, TypeScript, Node, NPM, Jest
\vspace{9pt}

\textbf{Software Engineer,} {Jovian Software Consulting, LLC} --- \textit{Remote} \hfill July 2023--Dec 2025 \\
\vspace{-9pt}
\begin{itemize}[leftmargin=0.35in]
...
\vspace{-9pt}
\begin{itemize}[leftmargin=0.35in]
  \item Developed, deployed, and maintained a low-maintenance on-premises web application to control serial displays
...
\vspace{-9pt}
\begin{itemize}
  \item Core contributor to growing book tracking platform with 150k users (Ruby on Rails, React, Inertia.js)
  \item Enhanced platform stability for 20k monthly active users by identifying, prioritizing, and resolving critical bugs and security vulnerabilities across the stack, ensuring reliable performance in the path to open sourcing
\end{itemize}
...
\vspace{-9pt}
\begin{itemize}[leftmargin=0.35in]
  \item Developed 3D printed robot w/ IR camera and proximity sensors, featuring python-based web interface for control
\end{itemize}
\vspace{-9pt}
\textbf{SKILLS:} Arduino, RaspberryPi, Python, JavaScript, Flask, CAD, Robotics, MySQL, Bash, Technical Documentation
\vspace{9pt}


\textbf{Machine Learning Researcher (\href{https://new.nsf.gov/funding/initiatives/reu}{NSF REU}),} {Cornell University} \hfill \href{https://github.com/sylphrena0/classe}{github.com/sylphrena0/classe}
